...
public class MarkovTextGeneratorLoL implements MarkovTextGenerator {
	...
	{
		// Added to make tests pass
		if(!this.wordList.isEmpty()) {
			System.out.println("You cannot retrain an already trained generator");
		}
	...
	public String generateText(int numWords) {
		...
		if(numWords == 0 || this.wordList.isEmpty()) {
			System.out.println("Requesting 0 words or not trained model");
			return "";
		}
	...
	public void retrain(String sourceText)
	{
		...
		// Originally, I thought I wrote a for-loop (loop through and nullify each node) for this but it was suggested to just clear the data structure with a new one altogether
		// Not only is this better algorithmically O(1) vs. O(n), but also achieves the same space saved in 1 line
